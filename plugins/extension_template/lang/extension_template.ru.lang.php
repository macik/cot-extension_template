...
$L['mplug_nojquery'] = 'Извините, данный плагин работает только при включенном Javascript и библиотеке jQuery. Включить её вы можете в меню <a href="'.cot_url('admin','m=config&n=edit&o=core&p=performance').'" title="Настройки производительности">настроек</a>.';
